...
var _user$project$Quiz_Question$MultipleChoice = F2(
	function (a, b) {
		return {ctor: 'MultipleChoice', _0: a, _1: b};
	});
var _user$project$Quiz_Question$TrueFalse = function (a) {
	return {ctor: 'TrueFalse', _0: a};
};
var _user$project$Quiz_Question$IntermediateMult = F2(
	function (a, b) {
		return {ctor: 'IntermediateMult', _0: a, _1: b};
	});
var _user$project$Quiz_Question$IntermediateQuestion = F2(
	function (a, b) {
		return {ctor: 'IntermediateQuestion', _0: a, _1: b};
	});
var _user$project$Quiz_Question$jsonSchema = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A3(
			_elm_lang$core$Json_Decode$map2,
			_user$project$Quiz_Question$IntermediateMult,
			A2(
		...
		_1: {
			...
			_0: A3(
				_elm_lang$core$Json_Decode$map2,
				_user$project$Quiz_Question$IntermediateQuestion,
				A2(_elm_lang$core$Json_Decode$field, 'prompt', _elm_lang$core$Json_Decode$string),
				A2(_elm_lang$core$Json_Decode$field, 'question_type', _elm_lang$core$Json_Decode$string)),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Quiz_Session$Session = F3(
	function (a, b, c) {
		return {quizId: a, state: b, socket: c};
	});
var _user$project$Quiz_Session$InSession = {ctor: 'InSession'};
var _user$project$Quiz_Session$Connected = {ctor: 'Connected'};
var _user$project$Quiz_Session$joined = function (session) {
	return _elm_lang$core$Native_Utils.update(
		session,
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'quiz_id',
						_1: _elm_lang$core$Json_Encode$string(session.quizId)
					},
					_1: {ctor: '[]'}
				}),
...
var _user$project$Quiz_Session$loadCurrentQuestion = function (session) {
	...
	switch (_p3.ctor) {
		...
		case 'Joining':
			return {ctor: '_Tuple2', _0: session, _1: _elm_lang$core$Platform_Cmd$none};
		case 'Connected':
			return A2(_user$project$Quiz_Session$getQuestion, session.quizId, session);
		default:
			return A2(_user$project$Quiz_Session$getQuestion, session.quizId, session);
	}
};
		...
		switch (_p4.ctor) {
			case 'Disconnected':
				var channel = A2(
					...
					_elm_lang$core$Basics$always(_user$project$Quiz_Msg$Noop),
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
						_elm_lang$core$Basics$always(_user$project$Quiz_Msg$SessionJoined),
						A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						session,
						{state: _user$project$Quiz_Session$Joining, socket: newSocket}),
					_1: cmd
				};
			case 'Joining':
				return {ctor: '_Tuple2', _0: session, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Quiz_Session$Disconnected = {ctor: 'Disconnected'};
var _user$project$Quiz_Session$newSession = function (quizId) {
	var socket = _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init('ws://on_course.dev:4000/socket/websocket'));
...
var _user$project$Quiz$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.session.socket, _user$project$Quiz_Msg$PhoenixMsg);
};
var _user$project$Quiz$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
				...
				if (_p3.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								question: _elm_lang$core$Maybe$Just(_p3._0)
							}),
			...
			default:
				var _p5 = _user$project$Quiz_Session$loadCurrentQuestion(
					_user$project$Quiz_Session$joined(model.session));
				var session = _p5._0;
				var cmd = _p5._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$Quiz$init = function (flags) {
	var _p6 = A2(
		_user$project$Quiz_Session$joinQuiz,
		flags.userId,
		_user$project$Quiz_Session$newSession(flags.quizId));
	var session = _p6._0;
	var cmd = _p6._1;
	return {
		ctor: '_Tuple2',
...
var _user$project$Quiz$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'quizId', _elm_lang$core$Json_Decode$string)));
var _user$project$Quiz$Flags = F2(
	function (a, b) {
...
var Elm = {};
Elm['Quiz'] = Elm['Quiz'] || {};
if (typeof _user$project$Quiz$main !== 'undefined') {
    _user$project$Quiz$main(Elm['Quiz'], 'Quiz', undefined);
}
